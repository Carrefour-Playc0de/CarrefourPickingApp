...
test('@xyz @Regression @Pedido (B2B-TC-446) Verificar que en la seccion botones Crear Pedidos el boton Seccion funciona correctamente', async ({menuCrearPedidosSectionButtonsSeccion}) => {
