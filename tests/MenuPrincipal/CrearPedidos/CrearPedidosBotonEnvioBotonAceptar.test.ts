...
test('@xyz @Regression @Pedido (B2B-TC-80) Verificar que funcione correctamente el boton Aceptar del modal Tipo de entrega de pedido Envio', async ({menuCrearPedidosBotonEnvio}) => {
