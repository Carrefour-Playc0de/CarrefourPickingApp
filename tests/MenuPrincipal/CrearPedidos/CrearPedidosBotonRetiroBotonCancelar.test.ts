...
test('@xyz @Regression @Pedido (B2B-TC-442) Verificar que funcione correctamente el boton Aceptar del modal Tipo de entrega de pedido Retiro', async ({menuCrearPedidosBotonRetiro}) => {
